...
function CarModels() {
  ...
  const btnstyles =
    "h-14 w-full bg-zinc-300 bg-opacity-70 flex items-center px-6 font-medium text-xl focus:bg-orangelight focus:text-white lg:h-16"
  const btnstylesfocus =
    "h-14 w-full bg-opacity-100 flex items-center px-6 font-medium text-xl bg-orangelight text-white focus:bg-orangelight focus:text-white lg:h-16"
  ...
  return (
    <div className="font-rubik pt-24 ">
      <div className="flex flex-col gap-4 items-center text-center">
        ...
        <p className="opacity-60 px-6 lg:w-1/3">
          Choose from a variety of our amazing vehicles to rent for your next
          adventure or business trip
        </p>
      </div>
      <div className="lg:flex xl:w-[70%] lg:mx-auto xl:min-h-[500px] lg:gap-4">
        <div className="flex flex-col w-full px-6 items-start pt-12 gap-2 lg:w-1/4">
          <button
        ...
        <div className="w-[90%] max-h-72 flex mx-auto mt-12 overflow-hidden relative lg:w-[450px] lg:h-[450px] lg:items-center  lg:max-h-none">
          {carImgArray.map((url) => (
            <img
              key={url}
              src={url}
         ...
         hover:bg-opacity-20 transition-all duration-100 ease-in-out xl:left-0 2xl:hidden xl:top-8 xl:h-[80%]"
         ...
         hover:bg-opacity-20 transition-all duration-100 ease-in-out 2xl:hidden xl:top-8 xl:h-[80%]"
        ...
        <div className="py-12 flex flex-col items-center justify-center lg:w-1/4 lg:min-h-[500px] xl:relative">
          <button
            className="absolute p-8 py-36 hidden cursor-pointer text-orange  hover:rounded-lg hover:bg-black
            hover:bg-opacity-20 transition-all duration-100 ease-in-out 2xl:absolute 2xl:flex xl:-left-[206%] xl:top-[15%]"
            onClick={showPrevImage}
          >
            <FaArrowAltCircleLeft className="size-8 stroke-white fill-black" />
          </button>
          <button
            className="absolute p-8 py-36 hidden cursor-pointer text-orange  hover:rounded-lg hover:bg-black
         hover:bg-opacity-20 transition-all duration-100 ease-in-out 2xl:absolute 2xl:flex xl:-left-[20%] xl:top-[15%]"
            onClick={showNextImage}
          >
            <FaArrowAltCircleRight className="size-8 stroke-white fill-black" />
          </button>
          <div className="h-12 w-4/5 flex gap-1 justify-center items-center bg-orangelight text-white text-lg z-10">
          ...
          <div className="w-4/5">
            ...
            <div className="flex justify-between px-4 lg:px-2 py-2 border-slate-400 border-2 ">
              <span className="border-r-2 pr-6 border-slate-400 w-1/2">
                Mark
              </span>
            ...
            <div className="flex justify-between px-4 lg:px-0 2xl:px-4 py-2 border-slate-400 border-2">
              <span className="border-r-2 pr-6 border-slate-400 w-1/2">
                Transmission
              </span>
